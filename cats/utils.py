...
def get_random_cats(num_cats=10): # Получаем несколько кошек
    api_key = "live_PNu5QqzQjXxgSsut8kUWXCL0x1hFdKzjlme1C0VvA5o10mapgfpuTDT9gzWdcdPl"
    if not api_key:
...
def get_random_dogs(num_dogs=5):
    api_key = "live_gDj6zX4BGQHb2aadNA5x4ozcEHCj0apSNfZY79GaQtqv8quOwqzDT4bGgzUyii13"
    if not api_key:
